    ...
    stdenv.mkDerivation
    {
      ...
      patches = [
        ...
        (fetchpatch {
          ...
          url =
            "https://github.com/GermainZ/xdg-desktop-portal-termfilechooser/commit/af0ae142f54dbf9b480b5c886bfb1319cd6ff25b.patch";
          hash = "sha256-AgLetBd9sP3G3OPpweVA0Qp9njfPVFXJi4m/rZsSxJc=";
        })
        (fetchpatch {
          name = "dont_hardcode_ranger.patch";
          url =
            "https://github.com/GermainZ/xdg-desktop-portal-termfilechooser/commit/4e0db3d4c1639582420847393884ca6bb990cfe5.patch";
      ...
      postPatch = ''
        ...
        substituteInPlace src/core/config.c \
          --replace-fail '"/usr/share/xdg-desktop-portal-termfilechooser/ranger-wrapper.sh"' '"${
            placeholder "out"
      ...
      meta = {
        ...
        description =
          "Xdg-desktop-portal backend for wlroots and the likes of ranger";
